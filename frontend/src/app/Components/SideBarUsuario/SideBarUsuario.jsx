      ...
      <div className="flex flex-col h-full">
        ...
        <div className="flex-grow overflow-y-auto p-4">
          ...
          <nav className="flex flex-col space-y-2">
            ...
            <Link
              href="/usuario"
              className={`flex items-center space-x-3 rounded-lg px-3 py-2.5 text-sm font-medium transition-colors ${pathname === '/usuario' ? 'bg-red-500 text-white shadow-sm' : 'text-gray-700 hover:bg-red-50 hover:text-red-600'}`}
            >
